...
TARGETDIR = ../../bin/Debug
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/x64/Debug/sbc-game
...
TARGETDIR = ../../bin/Debug
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/ARM64/Debug/sbc-game
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/x64/Release/sbc-game
...
TARGETDIR = ../../bin/Release
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/x86/Release/sbc-game
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = ../../bin/Release
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/ARM64/Release/sbc-game
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/x64/Debug_RGFW/sbc-game
...
TARGETDIR = ../../bin/Debug_RGFW
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/x86/Debug_RGFW/sbc-game
DEFINES += -DDEBUG -DPLATFORM_DESKTOP_RGFW -DGRAPHICS_API_OPENGL_33 -D_WIN32
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -Wshadow -g -std=c17
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m32 -Wshadow -g -std=c++17
LIBS += ../../bin/Debug_RGFW/raylib.lib -lwinmm -lgdi32 -lopengl32
...
TARGETDIR = ../../bin/Debug_RGFW
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/ARM64/Debug_RGFW/sbc-game
DEFINES += -DDEBUG -DPLATFORM_DESKTOP_RGFW -DGRAPHICS_API_OPENGL_33 -D_WIN32
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -Wshadow -g -std=c17
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -Wshadow -g -std=c++17
LIBS += ../../bin/Debug_RGFW/raylib.lib -lwinmm -lgdi32 -lopengl32
...
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/x64/Release_RGFW/sbc-game
...
TARGETDIR = ../../bin/Release_RGFW
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/x86/Release_RGFW/sbc-game
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP_RGFW -DGRAPHICS_API_OPENGL_33 -D_WIN32
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -Wshadow -O2 -std=c17 -Wl,--subsystem,windows
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m32 -Wshadow -O2 -std=c++17 -Wl,--subsystem,windows
LIBS += ../../bin/Release_RGFW/raylib.lib -lwinmm -lgdi32 -lopengl32
...
TARGETDIR = ../../bin/Release_RGFW
TARGET = $(TARGETDIR)/sbc-game.exe
OBJDIR = obj/ARM64/Release_RGFW/sbc-game
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP_RGFW -DGRAPHICS_API_OPENGL_33 -D_WIN32
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -Wshadow -O2 -std=c17 -Wl,--subsystem,windows
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -Wshadow -O2 -std=c++17 -Wl,--subsystem,windows
LIBS += ../../bin/Release_RGFW/raylib.lib -lwinmm -lgdi32 -lopengl32
...
GENERATED += $(OBJDIR)/request_manager.o
GENERATED += $(OBJDIR)/request_thread.o
GENERATED += $(OBJDIR)/scene_manager.o
GENERATED += $(OBJDIR)/thread_wrapper.o
OBJECTS += $(OBJDIR)/main.o
OBJECTS += $(OBJDIR)/map.o
OBJECTS += $(OBJDIR)/request.o
OBJECTS += $(OBJDIR)/request_manager.o
OBJECTS += $(OBJDIR)/request_thread.o
OBJECTS += $(OBJDIR)/scene_manager.o
OBJECTS += $(OBJDIR)/thread_wrapper.o
...
$(OBJDIR)/request.o: ../../src/request.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/request_manager.o: ../../src/request_manager.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/request_thread.o: ../../src/request_thread.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/scene_manager.o: ../../src/scene_manager.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/thread_wrapper.o: ../../src/thread_wrapper.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
